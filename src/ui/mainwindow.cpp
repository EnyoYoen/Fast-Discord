...
MainWindow::MainWindow() : Widget(nullptr)
{
    ...
    QObject::connect(rm, &Api::RessourceManager::guildCreated, leftColumn, &LeftColumn::addGuild);
    QObject::connect(rm, &Api::RessourceManager::guildUpdated, leftColumn, &LeftColumn::updateGuild);
    QObject::connect(rm, &Api::RessourceManager::guildDeleted, leftColumn, &LeftColumn::deleteGuild);
    QObject::connect(rm, &Api::RessourceManager::guildDeleted, middleColumn, &MiddleColumn::closeGuild);
    ...
    QObject::connect(rm, &Api::RessourceManager::guildDeleted, rightColumn, &RightColumn::closeGuild);
